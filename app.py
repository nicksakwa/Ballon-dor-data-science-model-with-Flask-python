...
def index():
    try:
        ...
        predictions_df = predict_ballon_dor('ballon_dor_winners_2015_2024.csv', 'ballon_dor_2025_shortlist.csv')
        ...
        # Catch any other unexpected errors and show a generic error page
